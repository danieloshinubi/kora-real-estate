    ...
    >
      <div className='h-full flex flex-col gap-8'>
        <div className='sm:flex gap-8 '>
          ...
          <div className='relative space-y-4 '>
            <div className='bg-[#333333] h-full p-6 rounded-lg flex flex-col w-full sm:max-w-[340px]'>
              <h4 className='lg:text-[28px] text-[20px] mb-4 text-[#CFCDBE]'>
              ...
              <div className='relative mt-auto'>
                <input
                  ...
                  className='w-full py-3 sm:pl-4 pr-12 bg-[#333333] bottom-b-[1px] border-gray-300 rounded-md focus:outline-none'
                />
            ...
            <div className='text-[#6F6D66] mb-0 hidden sm:flex'>
              <div className=' p-6'>
            ...
            <p className='text-[#6F6D66] hidden sm:block '>© 2023 — Copyright</p>
          </div>
          <div className='sm:ml-8 mt-16 sm:mt-0'>
            <div className='sm:w-[434px] sm:flex justify-between gap-8'>
              <h1>For Applicants</h1>
              <h1>For Students</h1>
              <h1>For PhD</h1>
            </div>
            <div className='mb-16'>
              <div className='sm:flex  justify-between lg:gap-64  text-[10px]'>
                <div className='flex flex-col gap-2 '>
                  <h5 className='text-[#6F6D66] py-4 sm:py-12'>INFO</h5>
                ...
                <div className='flex flex-col gap-2'>
                  <h5 className='text-[#6F6D66] py-4 sm:py-12'>ADDITIONAL</h5>
                  <div>
        ...
        <div className='flex gap-8 w-full'>
          <div className='w-[340px] hidden lg:flex'></div>
          <div className='flex flex-col gap-8 sm:ml-auto lg:ml-8'>
