...
export default function PriceCard() {
  return (
    <div className="bg-white md:pt-[30px] md:px-[20px] max-h-[512px] md:max-h-[412px] md:shadow-lg md:rounded-[20px]">
      ...
      <ul className={`${cabin.className} md:space-y-4 text-[18px] list-none py-4 lg:py-12 border-b-[0.5px]`}>
      ...
      <li className={`${cabin.className} flex justify-between text-[15px] lg:text-[20px] font-semibold`}>
